...
<head>
  ...
  <title>{{ config('Data Lengkap Peserta Didik Baru', 'Data Lengkap Peserta Didik Baru') }}</title>
          ...
          <div class="row">
            <div class="col">
                ...
                <div hidden class="form-group">
                  ...
                  <input disabled class="form-control @error('id') is-invalid @enderror" type="text" name="id" value="{{ old('kode') ?? $pendaftar->id }}">
                  @error('id')
                ...
                <div class="form-group">
                  ...
                  <input class="form-control @error('foto') is-invalid @enderror" type="file" id="image" name="foto">
                  @error('foto')
                    <span class="text-danger">{{ $message }}</span> 
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input disabled class="form-control @error('kode') is-invalid @enderror" type="text" name="kode" placeholder="Masukkan Kode Registrasi Yang Anda Dapat Dari Email" value="{{ old('kode') ?? $pendaftar->kode }}">
                  @error('kode')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input disabled class="form-control @error('nama') is-invalid @enderror" type="text" name="nama" value="{{ old('nama') ?? $pendaftar->nama }}">
                  @error('nama')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  ...
                  <input class="form-control @error('tgllahir') is-invalid @enderror" type="date" name="tgllahir">
                  @error('tgllahir')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <input class="form-control @error('alamat') is-invalid @enderror" type="text" name="alamat" placeholder="Alamat Rumah Anda">
                  @error('alamat')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                <div class="form-group">
                  ...
                  <select class="form-control @error('jeniskelamin') is-invalid @enderror" name="jeniskelamin" id="jeniskelamin" aria-label="Default select example">
                    <option value="" selected disabled>Pilih Jenis Kelamin Anda</option>
                ...
                <div class="form-group">
                  ...
                  <select class="form-control @error('agama') is-invalid @enderror" name="agama" id="agama" aria-label="Default select example">
                ...
                <div class="form-group">
                  ...
                  <input class="form-control @error('sekolahasal') is-invalid @enderror" type="text" name="sekolahasal">
                  @error('sekolahasal')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
                ...
                <div class="form-group">
                  <label for="telp">No. Telp<span class="small text-danger">*</span></label>
                  <input disabled class="form-control @error('telp') is-invalid @enderror" type="text" name="telp" placeholder="Masukkan No. Telp Anda" value="{{ old('telp') ?? $pendaftar->telp }}">
                  @error('telp')
                    <span class="text-danger">{{ $message }}</span>
                  @enderror
                </div>
